...
object ContentType {
  ...
  lazy val `application/wasm`: ContentType = ContentType("application", "wasm")
  ...
  lazy val `application/x-yaml`: ContentType = ContentType("application", "x-yaml")
  ...
  lazy val `text/yaml`: ContentType = ContentType("text", "yaml")
  ...
  given rw: RW[ContentType] = RW.from(ct => str(ct.outputString), v => parse(v.asStr.value), Definition(DefType.Str))
}