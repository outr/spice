...
libraryDependencies += "com.outr" %% "spice-core" % "1.2.0"

// HTTP client (pick one implementation)
libraryDependencies += "com.outr" %% "spice-client-jvm" % "1.2.0"    // java.net.http
libraryDependencies += "com.outr" %% "spice-client-okhttp" % "1.2.0" // OkHttp3
libraryDependencies += "com.outr" %% "spice-client-netty" % "1.2.0"  // Netty

// HTTP server (Undertow backend)
libraryDependencies += "com.outr" %% "spice-server-undertow" % "1.2.0"

// OpenAPI spec generation
libraryDependencies += "com.outr" %% "spice-openapi" % "1.2.0"
```
...
// In Scala.js code
libraryDependencies += "com.outr" %%% "spice-core" % "1.2.0"
libraryDependencies += "com.outr" %%% "spice-client" % "1.2.0"
```
