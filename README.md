...
libraryDependencies += "com.outr" %% "spice-core" % "1.10.5"

// HTTP client (pick one implementation)
libraryDependencies += "com.outr" %% "spice-client-jvm" % "1.10.5"    // java.net.http
libraryDependencies += "com.outr" %% "spice-client-okhttp" % "1.10.5" // OkHttp3
libraryDependencies += "com.outr" %% "spice-client-netty" % "1.10.5"  // Netty

// HTTP server (Undertow backend)
libraryDependencies += "com.outr" %% "spice-server-undertow" % "1.10.5"

// OpenAPI spec generation
libraryDependencies += "com.outr" %% "spice-openapi" % "1.10.5"
```
...
// In Scala.js code
libraryDependencies += "com.outr" %%% "spice-core" % "1.10.5"
libraryDependencies += "com.outr" %%% "spice-client" % "1.10.5"
```
