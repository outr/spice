...
libraryDependencies += "com.outr" %% "spice-core" % "1.5.1"

// HTTP client (pick one implementation)
libraryDependencies += "com.outr" %% "spice-client-jvm" % "1.5.1"    // java.net.http
libraryDependencies += "com.outr" %% "spice-client-okhttp" % "1.5.1" // OkHttp3
libraryDependencies += "com.outr" %% "spice-client-netty" % "1.5.1"  // Netty

// HTTP server (Undertow backend)
libraryDependencies += "com.outr" %% "spice-server-undertow" % "1.5.1"

// OpenAPI spec generation
libraryDependencies += "com.outr" %% "spice-openapi" % "1.5.1"
```
...
// In Scala.js code
libraryDependencies += "com.outr" %%% "spice-core" % "1.5.1"
libraryDependencies += "com.outr" %%% "spice-client" % "1.5.1"
```
