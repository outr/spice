...
libraryDependencies += "com.outr" %% "spice-core" % "@VERSION@"

// HTTP client (pick one implementation)
libraryDependencies += "com.outr" %% "spice-client-jvm" % "@VERSION@"    // java.net.http
libraryDependencies += "com.outr" %% "spice-client-okhttp" % "@VERSION@" // OkHttp3
libraryDependencies += "com.outr" %% "spice-client-netty" % "@VERSION@"  // Netty

// HTTP server (Undertow backend)
libraryDependencies += "com.outr" %% "spice-server-undertow" % "@VERSION@"

// OpenAPI spec generation
libraryDependencies += "com.outr" %% "spice-openapi" % "@VERSION@"
```
...
// In Scala.js code
libraryDependencies += "com.outr" %%% "spice-core" % "@VERSION@"
libraryDependencies += "com.outr" %%% "spice-client" % "@VERSION@"
```
